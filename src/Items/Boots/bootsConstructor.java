...
public class bootsConstructor extends armorConstructor {

    public bootsConstructor(String name, String desc, String type, int levelReq, int hpIncrease, int mpIncrease, String rarity, int sellPrice) {

package Items.Chestplates;

import Items.Armour.armorConstructor;
import Items.raritySelector;

public class chestplateConstructor extends armorConstructor {
    public chestplateConstructor(String name, String desc, String type, int levelReq, int hpIncrease, int mpIncrease, String rarity, int sellPrice) {

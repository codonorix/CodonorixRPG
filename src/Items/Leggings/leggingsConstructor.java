...
public class leggingsConstructor extends armorConstructor {
    public leggingsConstructor(String name, String desc, String type, int levelReq, int hpIncrease, int mpIncrease, String rarity, int sellPrice) {
